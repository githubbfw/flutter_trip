...
// 旅拍 的接口文档。 https://www.devio.org/io/flutter_app/json/travel_page.json
  String url;
  Params params;
  List<TraveTab> tabs;
  ...
  TravelTabModel.fromJson(Map<String, dynamic> json) {
    ...
    if (json['tabs'] != null) {
      tabs = new List<TraveTab>();
      json['tabs'].forEach((v) {
        tabs.add(new TraveTab.fromJson(v));
      });
    }
  }
...
class TraveTab {
  ...
  TraveTab({this.labelName, this.groupChannelCode});

  TraveTab.fromJson(Map<String, dynamic> json) {
